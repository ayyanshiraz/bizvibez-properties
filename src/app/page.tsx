    ...
    return (
        <>
            ...
            <section className="py-20 bg-cover bg-center text-white" style={{ backgroundImage: "linear-gradient(rgba(0,0,0,0.75), rgba(0,0,0,0.75)), url('/guides/hero/downtown.jpeg')" }}>
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16"><h2 className="text-4xl md:text-5xl font-bold">Dubai Real Estate Market Report</h2><p className="text-xl text-gray-300 mt-2">OCTOBER 2025</p></div>
                    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
                        <div className="space-y-12 text-center md:text-left"><div><h3 className="text-6xl font-bold">59.4B</h3><p className="text-gray-300">TOTAL SALES VALUE IN AED</p><p className="text-green-400 mt-1 text-lg">▲ 3.1% <span className="text-gray-400">increase when compared to October 2024</span></p></div><div><h3 className="text-6xl font-bold">19,875</h3><p className="text-gray-300">TOTAL SALES TRANSACTIONS</p><p className="text-green-400 mt-1 text-lg">▲ 3% <span className="text-gray-400">increase when compared to October 2024</span></p></div></div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8"><div className="flex flex-col items-center"><InteractivePieChart offplanPercent={66} secondaryPercent={34} color1="#D3D3D3" color2="#8D0169" /><h4 className="font-bold text-xl mt-4">VALUE</h4><ul className="text-sm mt-2 space-y-1 text-left"><li className="flex items-center"><span className="w-3 h-3 rounded-full bg-[#D3D3D3] mr-2"></span>OFFPLAN: 38.7B</li><li className="flex items-center"><span className="w-3 h-3 rounded-full bg-[#8D0169] mr-2"></span>SECONDARY: 20.7B</li></ul></div><div className="flex flex-col items-center"><InteractivePieChart offplanPercent={72} secondaryPercent={28} color1="#D3D3D3" color2="#8D0169" /><h4 className="font-bold text-xl mt-4">VOLUME</h4><ul className="text-sm mt-2 space-y-1 text-left"><li className="flex items-center"><span className="w-3 h-3 rounded-full bg-[#D3D3D3] mr-2"></span>OFFPLAN: 13,926</li><li className="flex items-center"><span className="w-3 h-3 rounded-full bg-[#8D0169] mr-2"></span>SECONDARY: 5,949</li></ul></div></div>
                    </div>
                </div>
            </section>
