    ...
    return (
      <div className="bg-white">
        ...
        <section 
          ...
          style={{ backgroundColor: '#891e6d', height: '420px' }}
        >
          ...
          <div className="container mx-auto px-6">
            ...
            {ceo && (
              <AnimatedCard>
                ...
                >
                  <div className="md:w-1/3 bg-black bg-opacity-10 flex items-center justify-center">
              ...
              {otherMembers.map((member, index) => (
                <AnimatedCard key={index}>
                  <div 
                    ...
                    style={cardBackgroundStyle}
                  >
                    <div className="h-64 w-full bg-black bg-opacity-10 flex items-center justify-center">
